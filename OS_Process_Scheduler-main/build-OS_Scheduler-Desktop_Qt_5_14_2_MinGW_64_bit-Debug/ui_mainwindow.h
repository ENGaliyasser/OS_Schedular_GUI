...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        algo_label->setObjectName(QString::fromUtf8("algo_label"));
        QFont font1;
        ...
        algorithm_comboBox->addItem(QString());
        algorithm_comboBox->addItem(QString());
        algorithm_comboBox->setObjectName(QString::fromUtf8("algorithm_comboBox"));
        ...
        no_process_label->setObjectName(QString::fromUtf8("no_process_label"));
        no_process_label->setFont(font1);

        horizontalLayout_2->addWidget(no_process_label);

        no_of_process_value = new QSpinBox(layoutWidget);
        no_of_process_value->setObjectName(QString::fromUtf8("no_of_process_value"));
        ...
        algo_type->setObjectName(QString::fromUtf8("algo_type"));
        ...
        Non_preemptive->setObjectName(QString::fromUtf8("Non_preemptive"));
        ...
        quantum_value->setObjectName(QString::fromUtf8("quantum_value"));
